 ...
 * 
 */
public class student_POV_HOMEPAGE extends javax.swing.JFrame {

    /**
     * Creates new form STUDENT_POV_HOMEPAGE
     */
    public student_POV_HOMEPAGE() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, -1, -1));
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 80, -1, -1));

        jLabel22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/JFRAME/Flex_FacilitiesR.jpg"))); // NOI18N
        jPanel1.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 1160, -1));
...
student_view_profile alp = null;
        try {
            ...
            Logger.getLogger(student_POV_HOMEPAGE.class.getName()).log(Level.SEVERE, null, ex);
        }
alp.show();
dispose();        // TODO add your handling code here:
...
JOptionPane.showMessageDialog(this, "Oops! Site under construction.Please try again later...");         // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(student_POV_HOMEPAGE.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new student_POV_HOMEPAGE().setVisible(true);
            }
        });
    }
