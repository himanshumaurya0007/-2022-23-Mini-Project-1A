...
public class student_issued_books extends javax.swing.JFrame {
    ...
    public student_issued_books() throws SQLException {
        initComponents();
        Connect();
        table_load();
    }
    ...
    private void initComponents() {
        ...
        tbl_issuebookDetails.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book ID", "Book Name", "Student ID", "Issue Date", "Due Date"
            }
        ));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 70, 1200, 810));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new student_issued_books().setVisible(true);
                } catch (SQLException ex) {
                    Logger.getLogger(student_issued_books.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    public rojerusan.RSTableMetro tbl_issuebookDetails;
