 ...
 * @author sumee
 */
public class teacher_forgot_password extends javax.swing.JFrame {

    /**
     * Creates new form teacher_forgot_password
     */
    public teacher_forgot_password() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teacher_forgot_password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teacher_forgot_password().setVisible(true);
            }
        });
    }
