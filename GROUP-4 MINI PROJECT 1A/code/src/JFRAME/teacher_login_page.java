 ...
 * @author sumee
 */
public class teacher_login_page extends javax.swing.JFrame {

    /**
     * Creates new form teacher_login_page
     */
    ...
    private void initComponents() {
        ...
        edtusername4 = new app.bolivia.swing.JCTextField();
        jLabel11 = new javax.swing.JLabel();
        jLabel7 = new javax.swing.JLabel();
        rSMaterialButtonCircle1 = new rojerusan.RSMaterialButtonCircle();
        rSMaterialButtonCircle2 = new rojerusan.RSMaterialButtonCircle();
        jLabel6 = new javax.swing.JLabel();
        edtpassword4 = new javax.swing.JPasswordField();
        ...
        jLabel5.setText("Login To Faculty Portal ");
        ...
        edtusername4.setBackground(new java.awt.Color(51, 102, 255));
        edtusername4.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(255, 255, 255)));
        edtusername4.setFont(new java.awt.Font("Segoe UI", 0, 17)); // NOI18N
        edtusername4.setPlaceholder("Enter Faculty ID...");
        jPanel2.add(edtusername4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 230, -1, 40));
        ...
        jPanel2.add(edtpassword4, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 350, 210, -1));
    ...
    private void rSMaterialButtonCircle1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle1ActionPerformed
        teacher_forgot_password alp = new  teacher_forgot_password();
        alp.show();
        dispose();        // TODO add your handling code here:
    ...
    private void rSMaterialButtonCircle2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle2ActionPerformed
        try{
            ...
            String username = edtusername4.getText();
            String password = edtpassword4.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teacher_login_page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teacher_login_page().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPasswordField edtpassword4;
    private app.bolivia.swing.JCTextField edtusername4;
